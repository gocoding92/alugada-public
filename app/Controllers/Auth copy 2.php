...
class Auth extends BaseController
{
    ...
    public function lockscreen()
    {
        ...
        $auth = $this->ModelAuth->lockscreen(123);

        $data = [
            'data_iklan_baru' => count($auth['data_iklan_baru']),
            'user_suspend' => count($auth['user_suspend']),
            'user_active' => count($auth['user_active']),
        ];

        return view('lockscreen/lockScreenView', $data);
    }
