<div class="row">
    ...
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
        ...
        <select name="kepemilikan" id="" class="form-control margin-top-6">
            ...
            <option value="">Girik</option>
            <option value="">Lainnya</option>
        </select>
    </div>
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
        <label for="" class="font-size-15">Akses Mobil</label>
        <select name="akses_mobil" id="" class="form-control margin-top-6">
            <option value="" disabled>-- Silahkan dipilih --</option>
            <option value="">Tidak Masuk Mobil</option>
            <option value="">Masuk Mobil</option>
        </select>
    </div>
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
