<form action="<?= base_url('/iklan/saveKostkontrakan'); ?>" method="post">
    ...
    <div class="row">
        <div class="margin-bottom-12 padding-right-46 padding-left-16">
            ...
            <textarea name="judul_iklan" cols="55" rows="3" placeholder="Kost/Kontrakan Fasilitas lengkap, AC non AC, kamar mandi dalam, Tempat tidur, meja, kursi, almari"></textarea>
        </div>
        <div class="margin-bottom-12 padding-right-46 padding-left-16">
