<div class="row">
    ...
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
        ...
        <select name="pendidikan" class="form-control">
            <option value="" selected>-- Pilih Bidang Profesi--</option>
            <option value="">Engineering</option>
            <option value="">Production</option>
            <option value="">Project</option>
            <option value="">Marketing</option>
            <option value="">Adm - Finance</option>
    ...
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
        ...
        <input type="number" name="nama_lengkap" class="form-control margin-top-6" placeholder="Tulis nama anda">
    </div>
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
    ...
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
        ...
        <input type="number" name="gaji" class="form-control margin-top-6" value="7000000">
    </div>
