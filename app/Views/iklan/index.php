      ...
      <?php if ($l['nolayanan'] == $d['nolayanan']) : ?>
        <div class="margin-top-min10 margin-left-16">
          <div class="display-flex margin-bottom-25 align-items-center margin-bottom-18">
            ...
            <a href="<?= base_url(); ?>/pasang-iklan/detail/<?= $l['layanan']; ?>/<?= $l['nolayanan']; ?>/<?= $d['sublayanan']; ?>/<?= $d['nosublayanan']; ?>" class="text-decoration-none width-85-percent textcolor-747474 margin-top-min5 margin-left-16 position-relative top9 font-size-14"> <?php echo $d['sublayanan']; ?> </a>
