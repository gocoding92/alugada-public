...
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Luas Bangunan</label>
        <p class="font-size-16"><?= $data_iklan['luasbangunan'] ?></p>
    </div>
    <div class="margin-bottom-12 width-50-percent">  
...
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Ruang Tamu</label>
        <p class="font-size-16"><?= $data_iklan['ruangtamu'] ?></p>
    </div>
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Ruang keluarga</label>
        <p class="font-size-16"><?= $data_iklan['ruangkeluarga'] ?></p>
    </div>
</div>
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Kamar Tidur</label>
        <p class="font-size-16"><?= $data_iklan['kamartidur'] ?></p>
    </div>
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Kamar Pembantu</label>
        <p class="font-size-16"><?= $data_iklan['kamarpembantu'] ?></p>
    </div>
</div>
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
    ...
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Teras</label>
        <p class="font-size-16"><?= $data_iklan['teras'] ?></p>
    </div>
</div>
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Taman</label>
        <p class="font-size-16"><?= $data_iklan['taman'] ?></p>
    </div>
    <div class="margin-bottom-12 width-50-percent">  
...
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
        <label class="label-detail-iklan" for="" class="font-size-18">Garasi</label>
        <p class="font-size-16"><?= $data_iklan['garasi'] ?></p>
    </div>
    <div class="margin-bottom-12 width-50-percent">  
...
<div class="display-flex">
    <div class="margin-bottom-12 width-50-percent">  
        ...
        <p class="font-size-16"><?= $data_iklan['harga']; ?></p>  
    </div>
</div>