    ...
    <div class="display-flex width-auto overflow-auto">
        <div class="select-image margin-bottom-12">
            <label for="inputTag" class="cursor-pointer font-size-14">
                <div id="imgInpView1">
                    <i class="fa fa-2x fa-camera" id="iconCamera1" style="<?= $data_iklan['image_1'] ? 'display:none;' : 'display:block;' ?>"></i>
                </div>
                <input
                    style="display: none;"
                    type="file"
                ...
                />
                <img id="img1" class="img-upload-iklan" src="<?= $data_iklan['image_1']; ?>" alt="your image" style="<?= $data_iklan['image_1'] ? 'display:block;' : 'display:none;' ?>" />
                <p id="deleteImg1" class="deleteImg" style="<?= $data_iklan['image_1'] ? 'display:block;' : 'display:none;' ?>"> Delete </p>

                <input type="hidden" name="uploadForm1" id="uploadForm1" value="<?= $data_iklan['image_1']; ?>" />
            </label>
        </div>
        <div class="select-image margin-bottom-12">
        <label for="inputTag" class="cursor-pointer font-size-14">
            <div id="imgInpView2">
                <i class="fa fa-2x fa-camera" id="iconCamera2" style="<?= $data_iklan['image_2'] ? 'display:none;' : 'display:block;' ?>"></i>
            </div>
            <input
                style="display: none;"
                type="file"
            ...
            />
            <img id="img2" class="img-upload-iklan" src="<?= $data_iklan['image_2']; ?>" alt="your image" style="<?= $data_iklan['image_2'] ? 'display:block;' : 'display:none;' ?>" />
            <p id="deleteImg2" class="deleteImg" style="<?= $data_iklan['image_2'] ? 'display:block;' : 'display:none;' ?>"> Delete </p>

            <input type="hidden" name="uploadForm2" id="uploadForm2" value="<?= $data_iklan['image_2']; ?>" />
        </label>
    </div>
    <div class="select-image margin-bottom-12">
        <label for="inputTag" class="cursor-pointer font-size-14">
            <div id="imgInpView3">
                <i class="fa fa-2x fa-camera" id="iconCamera3" style="<?= $data_iklan['image_3'] ? 'display:none;' : 'display:block;' ?>"></i>
            </div>
            <input
                style="display: none;"
                type="file"
            ...
            />
            <img id="img3" class="img-upload-iklan" src="<?= $data_iklan['image_3']; ?>" alt="your image" style="<?= $data_iklan['image_3'] ? 'display:block;' : 'display:none;' ?>" />
            <p id="deleteImg3" class="deleteImg" style="<?= $data_iklan['image_3'] ? 'display:block;' : 'display:none;' ?>"> Delete </p>
            
            <input type="hidden" name="uploadForm3" id="uploadForm3" value="<?= $data_iklan['image_3']; ?>" />
        </label>
    </div>
    </div>
</div>
