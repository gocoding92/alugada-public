...
<div id="home-page" class="row-sm padding-bottom-90">
  <h1 class="margin-left-16"> Layanan Kami </h1>
  <p class="margin-left-16">
    Kami siap membantu untuk memperkuat advokasi HAM dan mendukung kerja-kerja anda agar lebih efektif dan akuntabel melalui pemanfaatan data serta teknologi, informasi dan komunikasi.
  </p>
  <hr class="margin-left-16 margin-right-16" />
  <div class="row">
