...
<div id="home-page" class="row-sm padding-bottom-90">
  ...
  <div class="row">
    ...
    <div class="margin-bottom-12 padding-right-46 padding-left-16">
      ...
      <input required type="text" id="no_handphone" class="form-control margin-top-6">
    </div>

    <div class="margin-bottom-12 padding-right-20 padding-left-16 margin-top-20">
      <button class="btn btn-primary width-100-percent textcolor-white" id="submit"> Daftar </button>
    </div>
