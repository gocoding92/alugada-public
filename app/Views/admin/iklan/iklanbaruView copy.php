      ...
      <table class="table table-striped">
        ...
        <tbody>
          <?php foreach ($iklanbaru as $r) : ?>
            <form action="<?= base_url('detailiklanbaru1'); ?>" mothod="post">
              <tr>
                <?php if ($r['checked'] == 0 or $r['checked'] == "" or $r['checked'] == NULL) { ?>
                  <th scope="row"><input type="text" name="id_rekomendasi_iklan" value="<?= $r['id_rekomendasi_iklan']; ?>"></th>
                  <!-- <td><input readonly type="text" name="user_id" value="<?php //echo $r['user_id']; ?>"></td> -->
                  <td><p><?= $r['id_rekomendasi_iklan'];?></p></td>
