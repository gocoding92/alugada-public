...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-3">
          <a href="<?php $x='admin-iklan-baru';?><?= base_url($x).'/'.$x; ?>">
            <h1 class="m-0">Iklan Baru</h1>
            </a>
        </div>
        <div class="col-sm-2">
          <a href="<?php $x='admin-iklan-aktif';?><?= base_url($x).'/'.$x; ?>">
            <h1 class="m-0">Aktif</h1>
          </a>
        </div>
        <div class="col-sm-3">
          <!-- <a href="<?php //echo base_url('admin-iklan-tidak-aktif'); ?>"> -->
          <a href="<?php $x='admin-iklan-tidak-aktif';?><?= base_url($x).'/'.$x; ?>">
            <h1 class="m-0">Tidak Aktif</h1>
          </a>
        </div>
        <div class="col-sm-2">
          <!-- <a href="<?php //echo base_url('admin-iklan-suspend'); ?>"> -->
          <a href="<?php $x='admin-iklan-suspend';?><?= base_url($x).'/'.$x; ?>">
            <h1 class="m-0">Suspend</h1>
          </a>
        </div>
        <div class="col-sm-2">
          <!-- <a href="<?php //echo base_url('admin-iklan-block'); ?>"> -->
          <a href="<?php $x='admin-iklan-block';?><?= base_url($x).'/'.$x; ?>">
