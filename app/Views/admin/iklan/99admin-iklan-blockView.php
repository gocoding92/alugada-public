...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-3">
          <a href="<?= base_url('admin-iklan-baru');?>">
            <h1 class="m-0">Iklan Baru</h1>
          </a>
        </div>
        <div class="col-sm-2">
          <a href="<?= base_url('admin-iklan-aktif');?>">
            <h1 class="m-0">Aktif</h1>
          </a>
        </div>
        <div class="col-sm-3">
          <a href="<?= base_url('admin-iklan-tidak-aktif');?>">
            <h1 class="m-0">Tidak Aktif</h1>
          </a>
        </div>
        <div class="col-sm-2">
          <a href="<?= base_url('admin-iklan-suspend');?>">
            <h1 class="m-0">Suspend</h1>
          </a>
        </div>
        <div class="col-sm-2">
          <a href="<?= base_url('admin-iklan-block');?>">
