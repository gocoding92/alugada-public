                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="<?= base_url(); ?>/rumah" class="btn btn-default"><i class="fa fa-chevron-left"></i> Back to Mobil</a>
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p><?= $rumah['luasbangunan']; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Kepemilikan</label>
                                        <p><?= $rumah['kepemilikan']; ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p><?= $rumah['kamartidur']; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Kamar Pembantu</label>
                                        <p><?= $rumah['kamarpembantu']; ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
