      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('submit-form-insert-layanan');?>" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="layanan"  >
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="detaillayanan">Detail Layanan</label>
                                <input required type="text" class="form-control" name="detaillayanan"  >
                              </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="margin-bottom-12 padding-right-46 padding-left-16">
                                ...
                                <div class="col-sm-2">
                                    <img src="<?php echo base_url('Image/Layanan/layanandefault.png');?>" class="img-preview" style="width:50px" id="img-preview">
                                </div>
                                <div class="col-sm-8">
